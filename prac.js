...
// prac 31  обзработчики событие js 


// onclick - в HTML ввод обрабочика событий 
// onclick = "alert('Click')" - начзнчение обрабочика событий 

// addEventListener - обрабочик событий тоже самое но так принято и так правельно 


// addEventListener("click", ("аргумент")=>{
//     alert("clik");
